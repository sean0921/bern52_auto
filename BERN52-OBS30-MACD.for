...
c **********************************************************************
     ...
     +'\'//fod(11) 
      tmp='copy/y C:\BERN52\AUTO\T97_MACD.CRD '//apath(1:ii+6)//
     +'\'//fod(11)      
      call system(tmp)    
      tmp='copy/y C:\BERN52\AUTO\FIXSTA.SIG '//apath(1:ii+6)//
     +'\'//fod(11)          
      call system(tmp)
      !! create "RINEX.CRD" ********************************************
...
CC     +//' '//dyc//'1 '//apath
      if(ty==2) exe1='PERL C:\GPSUSER52\SCRIPT\BERN52_S30A_MACD.PL '
     +//yyc//' '//dyc//'1 '//apath
      if(ty==2) exe2='PERL C:\GPSUSER52\SCRIPT\BERN52_S30B_MACD.PL '
     +//yyc//' '//dyc//'1 '//apath
...
c **********************************************************************
     ...
     + 'SOL','STA'/
      ...
      do i=1,nnf
        tmp='copy/y '//opath(1:iii-1)//fixsta(i)//dyc//'1.'//y1c//'o '//
     +  apath(1:ii+6)//'\'//fod(9)
        call system(tmp)
      end do
      !! copy sp3 file to folder "ORB" *********************************
