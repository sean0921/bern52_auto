...
c *                                                                    *
c *                 created for 5.2 version by Kwo-Hwa Chen 2016.08.30 *
c **********************************************************************
      program cgs5230
...
CC      if(num.eq.0) then   
         cmm='md D:\GPSR\'//campname(1:6)//'P\SUM'
         call system(cmm)    
...
CC      call system(cmm)
      ...
      cmm='del/q C:\GPSUSER52\OPT\GS30_RES\GPSEST.bak'
      call system(cmm)
      cmm='ren C:\GPSUSER52\OPT\GS30_RES\GPSEST.INP GPSEST.bak'
      call system(cmm)
      cmm='copy/y GPSEST.RE1 C:\GPSUSER52\OPT\GS30_RES\GPSEST.INP'
      call system(cmm)
      cmm='del GPSEST.RE1'
      call system(cmm)
      
      cmm='del/q C:\GPSUSER52\OPT\GS30_FIN\GPSEST.bak'
      call system(cmm)
      cmm='ren C:\GPSUSER52\OPT\GS30_FIN\GPSEST.INP GPSEST.bak'
      call system(cmm)
      cmm='copy/y GPSEST.FI1 C:\GPSUSER52\OPT\GS30_FIN\GPSEST.INP'
      call system(cmm)
      cmm='del GPSEST.FI1'
      call system(cmm)  
      
      cmm='del/q C:\GPSUSER52\OPT\GS30_ADD\ADDNEQ2.bak'
      call system(cmm)
      cmm='ren C:\GPSUSER52\OPT\GS30_ADD\ADDNEQ2.INP ADDNEQ2.bak'
      call system(cmm)
      cmm='copy/y ADDNEQ2.INP C:\GPSUSER52\OPT\GS30_ADD\ADDNEQ2.INP'
      call system(cmm)
      cmm='del ADDNEQ2.INP'
      call system(cmm)
 
      cmm='BERN52-CGS30 RUN.INP'
      call system(cmm)

      cmm='copy D:\GPSR\'//campname(1:6)//'P\SOL\*.SNX C:\BERN52\AUTO\'
