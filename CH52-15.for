...
CC      call system(cmm)
      ...
      cmm='del/q C:\GPSUSER52\OPT\CH15_RES\GPSEST.bak'
      call system(cmm)
      cmm='ren C:\GPSUSER52\OPT\CH15_RES\GPSEST.INP GPSEST.bak'
      call system(cmm)
      cmm='copy/y GPSEST.RE1 C:\GPSUSER52\OPT\CH15_RES\GPSEST.INP'
      call system(cmm)
      cmm='del GPSEST.RE1'
      call system(cmm)

      cmm='del/q C:\GPSUSER52\OPT\CH15_FIN\GPSEST.bak'
      call system(cmm)
      cmm='ren C:\GPSUSER52\OPT\CH15_FIN\GPSEST.INP GPSEST.bak'
      call system(cmm)
      cmm='copy/y GPSEST.FI1 C:\GPSUSER52\OPT\CH15_FIN\GPSEST.INP'
      call system(cmm)
      cmm='del GPSEST.FI1'
      call system(cmm)

      cmm='del/q C:\GPSUSER52\OPT\CH15_ADD\ADDNEQ2.bak'
      call system(cmm)
      cmm='ren C:\GPSUSER52\OPT\CH15_ADD\ADDNEQ2.INP ADDNEQ2.bak'
      call system(cmm)
      cmm='copy/y ADDNEQ2.INP C:\GPSUSER52\OPT\CH15_ADD\ADDNEQ2.INP'
      call system(cmm)
      cmm='del ADDNEQ2.INP'
      call system(cmm)
