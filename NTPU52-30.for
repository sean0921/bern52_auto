...
c *                                                                    *
c *                 created for 5.2 version by Kwo-Hwa Chen 2017.04.12 *
c **********************************************************************
      program ntpu5230
...
CC      runf='RUN.INP'
      ...
      write(15,*) '2'
      write(15,'(a7,1x,a8,1x,a8,a7,a1)') campname(1:7),'E:\GPSR\','E:\GPSD\',campname,'\'
...
CC      call system(cmm)
      ...
      cmm='dir/b/o E:\GPSD\'//campname//'\*.??O > BASE.LST'
      call system(cmm)
...
CC      if(num.eq.0) then
         cmm='md E:\GPSR\'//campname(1:7)//'\SUM'
         call system(cmm)
...
CC      call system(cmm)
      ...
      cmm='del/q C:\GPSUSER52\OPT\TP30_RES\GPSEST.bak'
      call system(cmm)
      cmm='ren C:\GPSUSER52\OPT\TP30_RES\GPSEST.INP GPSEST.bak'
      call system(cmm)
      cmm='copy/y GPSEST.RE1 C:\GPSUSER52\OPT\TP30_RES\GPSEST.INP'
      call system(cmm)
      cmm='del GPSEST.RE1'
      call system(cmm)

      cmm='del/q C:\GPSUSER52\OPT\TP30_FIN\GPSEST.bak'
      call system(cmm)
      cmm='ren C:\GPSUSER52\OPT\TP30_FIN\GPSEST.INP GPSEST.bak'
      call system(cmm)
      cmm='copy/y GPSEST.FI1 C:\GPSUSER52\OPT\TP30_FIN\GPSEST.INP'
      call system(cmm)
      cmm='del GPSEST.FI1'
      call system(cmm)

      cmm='del/q C:\GPSUSER52\OPT\TP30_ADD\ADDNEQ2.bak'
      call system(cmm)
      cmm='ren C:\GPSUSER52\OPT\TP30_ADD\ADDNEQ2.INP ADDNEQ2.bak'
      call system(cmm)
      cmm='copy/y ADDNEQ2.INP C:\GPSUSER52\OPT\TP30_ADD\ADDNEQ2.INP'
      call system(cmm)
      cmm='del ADDNEQ2.INP'
      call system(cmm)

      cmm='BERN52-OBS30 RUN.INP'
      call system(cmm)

      cmm='copy E:\GPSR\'//campname(1:7)//'\SOL\*.SNX C:\BERN52\AUTO\'
...
CC      call system(cmm)
      ...
      cmm='move C:\BERN52\AUTO\*.SUM E:\GPSR\'//campname(1:7)//'\SUM\'
      call system(cmm)
      cmm='rename E:\GPSR\'//campname(1:7)//' '//campname(1:7)//'P'
      call system(cmm)
